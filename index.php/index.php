...
$curl=auto("http://giaothonghocduong.com.vn/danh-sach-thi-sinh.html?round=&user_name=&full_name=&region=bac&city_id=35&district_id=404&level=&school_id=30008&class_id=11");
...
$noidung=str_replace('<a class="text-bold no-hover" href="/','<a class="text-bold no-hover" href="http://giaothonghocduong.com.vn/',$noidung);
echo $noidung;
